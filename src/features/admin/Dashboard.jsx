...
const TYPE_LABELS_AR = {
    ...
    high: 'ثانوية',
    university: 'جامعة',
    training: 'مركز تكوين مهني',
    vocational: 'تكوين مهني',
    private: 'مدرسة خاصة',
    private_primary: 'مدرسة ابتدائية خاصة',
    private_high: 'مدرسة عالية خاصة',
    private_institute: 'معهد خاص',
    quranic: 'مدرسة قرآنية',
};
const TYPE_LABELS_FR = {
    school: 'École',
    nursery: 'Crèche',
    kindergarten: 'Crèche / Jardin d’enfants',
    ...
    private_primary: 'École primaire privée',
    private_high: 'École supérieure privée',
    private_institute: 'Institut privé',
